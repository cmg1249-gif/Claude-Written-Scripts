"""
Ducky Cam with Audio — CAMERA SERVER (always-on control server; runs on the host).

Same as Ducky Cam v2, plus the host MICROPHONE. Camera and mic both stay OFF
